...
public class BankAccountResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.BankAccount[] bankAccount;
    ...
    public BankAccountResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.BankAccount[] bankAccount) {
        super(
            executionStatus);
     ...
     * @return bankAccount
     */
    public business_partner.beans.ws.mdm.sap.com.BankAccount[] getBankAccount() {
        return bankAccount;
    }
     ...
     * @param bankAccount
     */
    public void setBankAccount(business_partner.beans.ws.mdm.sap.com.BankAccount[] bankAccount) {
        this.bankAccount = bankAccount;
    }

    public business_partner.beans.ws.mdm.sap.com.BankAccount getBankAccount(int i) {
        return this.bankAccount[i];
    }

    public void setBankAccount(int i, business_partner.beans.ws.mdm.sap.com.BankAccount _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BankAccountResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("bankAccount");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "bankAccount"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BankAccount"));
