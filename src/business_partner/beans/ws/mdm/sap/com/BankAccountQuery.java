...
public class BankAccountQuery  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.BankAccountCriteria criteria;
    ...
    public BankAccountQuery(
           business_partner.beans.ws.mdm.sap.com.BankAccountCriteria criteria,
     ...
     * @return criteria
     */
    public business_partner.beans.ws.mdm.sap.com.BankAccountCriteria getCriteria() {
        return criteria;
    }
     ...
     * @param criteria
     */
    public void setCriteria(business_partner.beans.ws.mdm.sap.com.BankAccountCriteria criteria) {
        this.criteria = criteria;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BankAccountQuery"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BankAccountCriteria"));
