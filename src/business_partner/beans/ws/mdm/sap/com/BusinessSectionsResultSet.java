...
public class BusinessSectionsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.BusinessSections[] businessSections;
    ...
    public BusinessSectionsResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.BusinessSections[] businessSections) {
        super(
            executionStatus);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.BusinessSections[] getBusinessSections() {
        return businessSections;
    }
     ...
     */
    public void setBusinessSections(business_partner.beans.ws.mdm.sap.com.BusinessSections[] businessSections) {
        this.businessSections = businessSections;
    }

    public business_partner.beans.ws.mdm.sap.com.BusinessSections getBusinessSections(int i) {
        return this.businessSections[i];
    }

    public void setBusinessSections(int i, business_partner.beans.ws.mdm.sap.com.BusinessSections _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BusinessSectionsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("businessSections");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "businessSections"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BusinessSections"));
