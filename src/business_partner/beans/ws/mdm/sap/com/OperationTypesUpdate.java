...
public class OperationTypesUpdate  extends business_partner.beans.ws.mdm.sap.com.OperationTypesCreate  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.OperationTypesID recordIdentification;
    ...
    public OperationTypesUpdate(
           ...
           business_partner.beans.ws.mdm.sap.com.OperationTypesID recordIdentification) {
        super(
            code,
            name);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.OperationTypesID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(business_partner.beans.ws.mdm.sap.com.OperationTypesID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "OperationTypesUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "OperationTypesID"));
