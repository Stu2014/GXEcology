...
public class TitlesResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.Titles[] titles;
    ...
    public TitlesResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.Titles[] titles) {
        super(
            executionStatus);
        this.titles = titles;
    }
     ...
     * @return titles
     */
    public business_partner.beans.ws.mdm.sap.com.Titles[] getTitles() {
        return titles;
    }
     ...
     * @param titles
     */
    public void setTitles(business_partner.beans.ws.mdm.sap.com.Titles[] titles) {
        this.titles = titles;
    }

    public business_partner.beans.ws.mdm.sap.com.Titles getTitles(int i) {
        return this.titles[i];
    }

    public void setTitles(int i, business_partner.beans.ws.mdm.sap.com.Titles _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "TitlesResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("titles");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "titles"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Titles"));
