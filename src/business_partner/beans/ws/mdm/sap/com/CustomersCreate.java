...
public class CustomersCreate  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private business_partner.beans.ws.mdm.sap.com.CustomerAccountGroupsLookup kTOKD;

    private business_partner.beans.ws.mdm.sap.com.TitlesLookup aNRED;

    private business_partner.beans.ws.mdm.sap.com.CustomerTypeLookup customerType;
    ...
    private business_partner.beans.ws.mdm.sap.com.TradePartnersLookup vBUND;
    ...
    /**
     * Gets the cERTI value for this CustomersCreate.
     * 
     * @return cERTI
     */
    ...
    /**
     * Sets the cERTI value for this CustomersCreate.
     * 
     * @param cERTI
     */
    ...
    /**
     * Gets the oRGNI value for this CustomersCreate.
     * 
     * @return oRGNI
     */
    ...
    /**
     * Sets the oRGNI value for this CustomersCreate.
     * 
     * @param oRGNI
     */
    ...
    /**
     * Gets the aDDRESS value for this CustomersCreate.
     * 
     * @return aDDRESS
     */
    ...
    /**
     * Sets the aDDRESS value for this CustomersCreate.
     * 
     * @param aDDRESS
     */
     ...
     * @return kTOKD
     */
    public business_partner.beans.ws.mdm.sap.com.CustomerAccountGroupsLookup getKTOKD() {
        return kTOKD;
    }
     ...
     * @param kTOKD
     */
    public void setKTOKD(business_partner.beans.ws.mdm.sap.com.CustomerAccountGroupsLookup kTOKD) {
        this.kTOKD = kTOKD;
    }
    ...
    /**
     * Gets the customerType value for this CustomersCreate.
     * 
     * @return customerType
     */
    public business_partner.beans.ws.mdm.sap.com.CustomerTypeLookup getCustomerType() {
        return customerType;
    }


    /**
     * Sets the customerType value for this CustomersCreate.
     * 
     * @param customerType
     */
    public void setCustomerType(business_partner.beans.ws.mdm.sap.com.CustomerTypeLookup customerType) {
        this.customerType = customerType;
    }
     ...
     * @return vBUND
     */
    public business_partner.beans.ws.mdm.sap.com.TradePartnersLookup getVBUND() {
        return vBUND;
    }
     ...
     * @param vBUND
     */
    public void setVBUND(business_partner.beans.ws.mdm.sap.com.TradePartnersLookup vBUND) {
        this.vBUND = vBUND;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "CustomersCreate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "CustomerAccountGroupsLookup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "CustomerTypeLookup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
