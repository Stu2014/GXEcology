...
public class TaxPayerKindsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.TaxPayerKinds[] taxPayerKinds;
    ...
    public TaxPayerKindsResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.TaxPayerKinds[] taxPayerKinds) {
        super(
            executionStatus);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.TaxPayerKinds[] getTaxPayerKinds() {
        return taxPayerKinds;
    }
     ...
     * @param taxPayerKinds
     */
    public void setTaxPayerKinds(business_partner.beans.ws.mdm.sap.com.TaxPayerKinds[] taxPayerKinds) {
        this.taxPayerKinds = taxPayerKinds;
    }

    public business_partner.beans.ws.mdm.sap.com.TaxPayerKinds getTaxPayerKinds(int i) {
        return this.taxPayerKinds[i];
    }

    public void setTaxPayerKinds(int i, business_partner.beans.ws.mdm.sap.com.TaxPayerKinds _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "TaxPayerKindsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("taxPayerKinds");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "taxPayerKinds"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "TaxPayerKinds"));
