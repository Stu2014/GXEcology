...
public class OperationTypesResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.OperationTypes[] operationTypes;
    ...
    public OperationTypesResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.OperationTypes[] operationTypes) {
        super(
            executionStatus);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.OperationTypes[] getOperationTypes() {
        return operationTypes;
    }
     ...
     */
    public void setOperationTypes(business_partner.beans.ws.mdm.sap.com.OperationTypes[] operationTypes) {
        this.operationTypes = operationTypes;
    }

    public business_partner.beans.ws.mdm.sap.com.OperationTypes getOperationTypes(int i) {
        return this.operationTypes[i];
    }

    public void setOperationTypes(int i, business_partner.beans.ws.mdm.sap.com.OperationTypes _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "OperationTypesResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("operationTypes");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "operationTypes"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "OperationTypes"));
