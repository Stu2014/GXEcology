...
public class ServiceRelationshipsTupleTuple  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private business_partner.beans.ws.mdm.sap.com.ClientSystemsLookup cLIENT_SYSTEM;
    ...
    public ServiceRelationshipsTupleTuple(
           ...
           business_partner.beans.ws.mdm.sap.com.ClientSystemsLookup cLIENT_SYSTEM,
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.ClientSystemsLookup getCLIENT_SYSTEM() {
        return cLIENT_SYSTEM;
    }
     ...
     * @param cLIENT_SYSTEM
     */
    public void setCLIENT_SYSTEM(business_partner.beans.ws.mdm.sap.com.ClientSystemsLookup cLIENT_SYSTEM) {
        this.cLIENT_SYSTEM = cLIENT_SYSTEM;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "ServiceRelationshipsTupleTuple"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "ClientSystemsLookup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
