...
public class BanksResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.Banks[] banks;
    ...
    public BanksResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.Banks[] banks) {
        super(
            executionStatus);
        this.banks = banks;
    }
     ...
     * @return banks
     */
    public business_partner.beans.ws.mdm.sap.com.Banks[] getBanks() {
        return banks;
    }
     ...
     * @param banks
     */
    public void setBanks(business_partner.beans.ws.mdm.sap.com.Banks[] banks) {
        this.banks = banks;
    }

    public business_partner.beans.ws.mdm.sap.com.Banks getBanks(int i) {
        return this.banks[i];
    }

    public void setBanks(int i, business_partner.beans.ws.mdm.sap.com.Banks _value) {
        this.banks[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BanksResultSet"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Banks"));
