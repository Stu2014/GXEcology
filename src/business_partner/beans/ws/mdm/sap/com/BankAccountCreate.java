...
public class BankAccountCreate  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private business_partner.beans.ws.mdm.sap.com.TradePartnersLookup bUKRS;
    ...
    private business_partner.beans.ws.mdm.sap.com.CurrencyLookup wAERS;
     ...
     * @return bUKRS
     */
    public business_partner.beans.ws.mdm.sap.com.TradePartnersLookup getBUKRS() {
        return bUKRS;
    }
     ...
     * @param bUKRS
     */
    public void setBUKRS(business_partner.beans.ws.mdm.sap.com.TradePartnersLookup bUKRS) {
        this.bUKRS = bUKRS;
    }
     ...
     * @return wAERS
     */
    public business_partner.beans.ws.mdm.sap.com.CurrencyLookup getWAERS() {
        return wAERS;
    }
     ...
     * @param wAERS
     */
    public void setWAERS(business_partner.beans.ws.mdm.sap.com.CurrencyLookup wAERS) {
        this.wAERS = wAERS;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "BankAccountCreate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "CurrencyLookup"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
        elemField = new org.apache.axis.description.ElementDesc();
