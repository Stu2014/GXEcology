...
public class VendorAccountGroupsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.VendorAccountGroups[] vendorAccountGroups;
    ...
    public VendorAccountGroupsResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.VendorAccountGroups[] vendorAccountGroups) {
        super(
            executionStatus);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.VendorAccountGroups[] getVendorAccountGroups() {
        return vendorAccountGroups;
    }
     ...
     */
    public void setVendorAccountGroups(business_partner.beans.ws.mdm.sap.com.VendorAccountGroups[] vendorAccountGroups) {
        this.vendorAccountGroups = vendorAccountGroups;
    }

    public business_partner.beans.ws.mdm.sap.com.VendorAccountGroups getVendorAccountGroups(int i) {
        return this.vendorAccountGroups[i];
    }

    public void setVendorAccountGroups(int i, business_partner.beans.ws.mdm.sap.com.VendorAccountGroups _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "VendorAccountGroupsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("vendorAccountGroups");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "vendorAccountGroups"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "VendorAccountGroups"));
