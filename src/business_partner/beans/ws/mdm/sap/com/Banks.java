...
public class Banks  extends business_partner.beans.ws.mdm.sap.com.BanksUpdate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Banks"));
