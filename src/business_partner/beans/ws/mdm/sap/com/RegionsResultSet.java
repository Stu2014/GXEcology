...
public class RegionsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.Regions[] regions;
    ...
    public RegionsResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.Regions[] regions) {
        super(
            executionStatus);
     ...
     * @return regions
     */
    public business_partner.beans.ws.mdm.sap.com.Regions[] getRegions() {
        return regions;
    }
     ...
     * @param regions
     */
    public void setRegions(business_partner.beans.ws.mdm.sap.com.Regions[] regions) {
        this.regions = regions;
    }

    public business_partner.beans.ws.mdm.sap.com.Regions getRegions(int i) {
        return this.regions[i];
    }

    public void setRegions(int i, business_partner.beans.ws.mdm.sap.com.Regions _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "RegionsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("regions");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "regions"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Regions"));
