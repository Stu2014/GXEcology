...
public class CustomerAccountGroups  extends business_partner.beans.ws.mdm.sap.com.CustomerAccountGroupsUpdate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "CustomerAccountGroups"));
