...
public class LanguagesUpdate  extends business_partner.beans.ws.mdm.sap.com.LanguagesCreate  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.LanguagesID recordIdentification;
    ...
    public LanguagesUpdate(
           ...
           business_partner.beans.ws.mdm.sap.com.LanguagesID recordIdentification) {
        super(
            code,
            name);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.LanguagesID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(business_partner.beans.ws.mdm.sap.com.LanguagesID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "LanguagesUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "LanguagesID"));
