...
public class LanguagesResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.Languages[] languages;
    ...
    public LanguagesResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.Languages[] languages) {
        super(
            executionStatus);
     ...
     * @return languages
     */
    public business_partner.beans.ws.mdm.sap.com.Languages[] getLanguages() {
        return languages;
    }
     ...
     * @param languages
     */
    public void setLanguages(business_partner.beans.ws.mdm.sap.com.Languages[] languages) {
        this.languages = languages;
    }

    public business_partner.beans.ws.mdm.sap.com.Languages getLanguages(int i) {
        return this.languages[i];
    }

    public void setLanguages(int i, business_partner.beans.ws.mdm.sap.com.Languages _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "LanguagesResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("languages");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "languages"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Languages"));
