...
public class CountriesResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.Countries[] countries;
    ...
    public CountriesResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.Countries[] countries) {
        super(
            executionStatus);
     ...
     * @return countries
     */
    public business_partner.beans.ws.mdm.sap.com.Countries[] getCountries() {
        return countries;
    }
     ...
     * @param countries
     */
    public void setCountries(business_partner.beans.ws.mdm.sap.com.Countries[] countries) {
        this.countries = countries;
    }

    public business_partner.beans.ws.mdm.sap.com.Countries getCountries(int i) {
        return this.countries[i];
    }

    public void setCountries(int i, business_partner.beans.ws.mdm.sap.com.Countries _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "CountriesResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("countries");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "countries"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Countries"));
