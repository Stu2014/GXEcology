...
public class ServiceRelationshipsUpdate  extends business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsCreate  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsID recordIdentification;
    ...
    public ServiceRelationshipsUpdate(
           ...
           business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsID recordIdentification) {
        super(
            cLIENT_SYSTEM,
            cLIENT_SYSTEM_NAME,
            dGUID,
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(business_partner.beans.ws.mdm.sap.com.ServiceRelationshipsID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "ServiceRelationshipsUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "ServiceRelationshipsID"));
