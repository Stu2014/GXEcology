...
public class TradePartners  extends business_partner.beans.ws.mdm.sap.com.TradePartnersUpdate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "TradePartners"));
