...
public class RegionsCriteria  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private beans.ws.mdm.sap.com.TextCriteria countryRegion;
    ...
    public RegionsCriteria(
           ...
           beans.ws.mdm.sap.com.TextCriteria countryRegion) {
    ...
    /**
     * Gets the countryRegion value for this RegionsCriteria.
     * 
     * @return countryRegion
     */
    public beans.ws.mdm.sap.com.TextCriteria getCountryRegion() {
        return countryRegion;
    }


    /**
     * Sets the countryRegion value for this RegionsCriteria.
     * 
     * @param countryRegion
     */
    public void setCountryRegion(beans.ws.mdm.sap.com.TextCriteria countryRegion) {
        this.countryRegion = countryRegion;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "RegionsCriteria"));
