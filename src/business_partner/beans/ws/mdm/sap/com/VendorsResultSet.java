...
public class VendorsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.Vendors[] vendors;
    ...
    public VendorsResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.Vendors[] vendors) {
        super(
            executionStatus);
     ...
     * @return vendors
     */
    public business_partner.beans.ws.mdm.sap.com.Vendors[] getVendors() {
        return vendors;
    }
     ...
     * @param vendors
     */
    public void setVendors(business_partner.beans.ws.mdm.sap.com.Vendors[] vendors) {
        this.vendors = vendors;
    }

    public business_partner.beans.ws.mdm.sap.com.Vendors getVendors(int i) {
        return this.vendors[i];
    }

    public void setVendors(int i, business_partner.beans.ws.mdm.sap.com.Vendors _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "VendorsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("vendors");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "vendors"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "Vendors"));
