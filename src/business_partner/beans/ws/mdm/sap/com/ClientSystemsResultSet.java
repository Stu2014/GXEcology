...
public class ClientSystemsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private business_partner.beans.ws.mdm.sap.com.ClientSystems[] clientSystems;
    ...
    public ClientSystemsResultSet(
           ...
           business_partner.beans.ws.mdm.sap.com.ClientSystems[] clientSystems) {
        super(
            executionStatus);
     ...
     */
    public business_partner.beans.ws.mdm.sap.com.ClientSystems[] getClientSystems() {
        return clientSystems;
    }
     ...
     * @param clientSystems
     */
    public void setClientSystems(business_partner.beans.ws.mdm.sap.com.ClientSystems[] clientSystems) {
        this.clientSystems = clientSystems;
    }

    public business_partner.beans.ws.mdm.sap.com.ClientSystems getClientSystems(int i) {
        return this.clientSystems[i];
    }

    public void setClientSystems(int i, business_partner.beans.ws.mdm.sap.com.ClientSystems _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "ClientSystemsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("clientSystems");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "clientSystems"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.business_partner", "ClientSystems"));
