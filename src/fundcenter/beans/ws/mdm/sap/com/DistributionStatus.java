...
public class DistributionStatus  extends fundcenter.beans.ws.mdm.sap.com.DistributionStatusUpdate  implements java.io.Serializable {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "DistributionStatus"));
