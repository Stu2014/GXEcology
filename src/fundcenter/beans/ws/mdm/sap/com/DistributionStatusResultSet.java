...
public class DistributionStatusResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private fundcenter.beans.ws.mdm.sap.com.DistributionStatus[] distributionStatus;
    ...
    public DistributionStatusResultSet(
           ...
           fundcenter.beans.ws.mdm.sap.com.DistributionStatus[] distributionStatus) {
        super(
            executionStatus);
     ...
     */
    public fundcenter.beans.ws.mdm.sap.com.DistributionStatus[] getDistributionStatus() {
        return distributionStatus;
    }
     ...
     */
    public void setDistributionStatus(fundcenter.beans.ws.mdm.sap.com.DistributionStatus[] distributionStatus) {
        this.distributionStatus = distributionStatus;
    }

    public fundcenter.beans.ws.mdm.sap.com.DistributionStatus getDistributionStatus(int i) {
        return this.distributionStatus[i];
    }

    public void setDistributionStatus(int i, fundcenter.beans.ws.mdm.sap.com.DistributionStatus _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "DistributionStatusResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("distributionStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "distributionStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "DistributionStatus"));
