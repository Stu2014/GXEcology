...
public class ServiceRelationshipsResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private fundcenter.beans.ws.mdm.sap.com.ServiceRelationships[] serviceRelationships;
    ...
    public ServiceRelationshipsResultSet(
           ...
           fundcenter.beans.ws.mdm.sap.com.ServiceRelationships[] serviceRelationships) {
        super(
            executionStatus);
     ...
     */
    public fundcenter.beans.ws.mdm.sap.com.ServiceRelationships[] getServiceRelationships() {
        return serviceRelationships;
    }
     ...
     */
    public void setServiceRelationships(fundcenter.beans.ws.mdm.sap.com.ServiceRelationships[] serviceRelationships) {
        this.serviceRelationships = serviceRelationships;
    }

    public fundcenter.beans.ws.mdm.sap.com.ServiceRelationships getServiceRelationships(int i) {
        return this.serviceRelationships[i];
    }

    public void setServiceRelationships(int i, fundcenter.beans.ws.mdm.sap.com.ServiceRelationships _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "ServiceRelationshipsResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("serviceRelationships");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "serviceRelationships"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "ServiceRelationships"));
