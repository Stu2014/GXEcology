...
public class OperationResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private fundcenter.beans.ws.mdm.sap.com.Operation[] operation;
    ...
    public OperationResultSet(
           ...
           fundcenter.beans.ws.mdm.sap.com.Operation[] operation) {
        super(
            executionStatus);
     ...
     * @return operation
     */
    public fundcenter.beans.ws.mdm.sap.com.Operation[] getOperation() {
        return operation;
    }
     ...
     * @param operation
     */
    public void setOperation(fundcenter.beans.ws.mdm.sap.com.Operation[] operation) {
        this.operation = operation;
    }

    public fundcenter.beans.ws.mdm.sap.com.Operation getOperation(int i) {
        return this.operation[i];
    }

    public void setOperation(int i, fundcenter.beans.ws.mdm.sap.com.Operation _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "OperationResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("operation");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "operation"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "Operation"));
