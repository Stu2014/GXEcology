...
public class OperationID  extends base.core.mdm.sap.com.AbstractMdmDataObject  implements java.io.Serializable {
    ...
    private fundcenter.beans.ws.mdm.sap.com.OperationDisplayFields displayFields;
    ...
    public OperationID(
           ...
           fundcenter.beans.ws.mdm.sap.com.OperationDisplayFields displayFields) {
     ...
     */
    public fundcenter.beans.ws.mdm.sap.com.OperationDisplayFields getDisplayFields() {
        return displayFields;
    }
     ...
     * @param displayFields
     */
    public void setDisplayFields(fundcenter.beans.ws.mdm.sap.com.OperationDisplayFields displayFields) {
        this.displayFields = displayFields;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "OperationID"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "displayFields"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "OperationDisplayFields"));
        elemField.setMinOccurs(0);
        elemField.setNillable(true);
        typeDesc.addFieldDesc(elemField);
    }
