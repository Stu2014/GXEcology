...
public class ClientUpdate  extends fundcenter.beans.ws.mdm.sap.com.ClientCreate  implements java.io.Serializable {
    private fundcenter.beans.ws.mdm.sap.com.ClientID recordIdentification;
     ...
     */
    public fundcenter.beans.ws.mdm.sap.com.ClientID getRecordIdentification() {
        return recordIdentification;
    }
     ...
     */
    public void setRecordIdentification(fundcenter.beans.ws.mdm.sap.com.ClientID recordIdentification) {
        this.recordIdentification = recordIdentification;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "ClientUpdate"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "ClientID"));
