...
public class ApprovalStatusResultSet  extends beans.ws.mdm.sap.com.ResultSetBase  implements java.io.Serializable {
    private fundcenter.beans.ws.mdm.sap.com.ApprovalStatus[] approvalStatus;
    ...
    public ApprovalStatusResultSet(
           ...
           fundcenter.beans.ws.mdm.sap.com.ApprovalStatus[] approvalStatus) {
        super(
            executionStatus);
     ...
     */
    public fundcenter.beans.ws.mdm.sap.com.ApprovalStatus[] getApprovalStatus() {
        return approvalStatus;
    }
     ...
     */
    public void setApprovalStatus(fundcenter.beans.ws.mdm.sap.com.ApprovalStatus[] approvalStatus) {
        this.approvalStatus = approvalStatus;
    }

    public fundcenter.beans.ws.mdm.sap.com.ApprovalStatus getApprovalStatus(int i) {
        return this.approvalStatus[i];
    }

    public void setApprovalStatus(int i, fundcenter.beans.ws.mdm.sap.com.ApprovalStatus _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "ApprovalStatusResultSet"));
        org.apache.axis.description.ElementDesc elemField = new org.apache.axis.description.ElementDesc();
        elemField.setFieldName("approvalStatus");
        elemField.setXmlName(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "approvalStatus"));
        elemField.setXmlType(new javax.xml.namespace.QName("urn:com.sap.mdm.ws.beans.fundcenter", "ApprovalStatus"));
